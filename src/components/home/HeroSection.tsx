...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, #1a1b3a 0%, #2d1f3d 40%, #1a2a3a 100%)" }}>
      ...
      <div className="absolute top-0 right-0 w-[50vw] max-w-[500px] h-[50vw] max-h-[500px] rounded-full opacity-10" style={{ background: "radial-gradient(circle, var(--accent) 0%, transparent 70%)" }} />
      <div className="absolute bottom-0 left-0 w-[40vw] max-w-[400px] h-[40vw] max-h-[400px] rounded-full opacity-8" style={{ background: "radial-gradient(circle, var(--teal) 0%, transparent 70%)" }} />
